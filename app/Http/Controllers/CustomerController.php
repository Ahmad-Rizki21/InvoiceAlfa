...
class CustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->json([
            ...
            'message' => __('Ok'),
            'data' => [
                'customers' => CustomerResource::collection($entries->items()),
            ],
            'meta' => [
    ...
    public function show(Request $request, $id)
    {
        ...
        return $this->json([
            ...
            'message' => __('Ok'),
            'data' => [
                'customer' => new CustomerResource($entry),
            ],
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $input = $request->validate([
            ...
            'type' => ['required', Rule::in(Customer::ALL_TYPES)],
            'email' => ['required', 'email', 'max:191', new UniqueEmailRule()],
            'username' => ['sometimes', 'nullable', 'min:3', 'max:30', new ValidUsernameRule(), new UniqueUsernameRule()],
            'password' => ['required', 'min:6', 'confirmed'],
            'corporate_name' => ['sometimes', 'nullable'],
        ...
        $entry = Customer::create($input);

        return $this->json([
            'status' => 'success',
            'message' => __(':entity successfully created', ['entity' => __('Customer')]),
            'data' => [
                'customer' => new CustomerResource($entry),
            ],
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$entry) {
            return abort(404, __(':entity not found', ['entity' => __('Customer')]));
        }

        $request->validate([
            'name' => ['required', 'max:191'],
            'email' => ['required', 'email', 'max:191', new UniqueEmailRule($entry)],
        ...
        $entry->fill([
            ...
            'corporate_name' => $request->has('corporate_name') ? $request->corporate_name : $entry->corporate_name,
        ...
        return $this->json([
            'status' => 'success',
            'message' => __(':entity successfully updated', ['entity' => __('Customer')]),
            'data' => [
                'customer' => new CustomerResource($entry),
            ],
        ]);
    ...
    public function destroy($id)
    {
        ...
        DB::transaction(function () use ($entry) {
            ...
            $entry->remoteLocations()->delete();
            $entry->delete();
        });

        return $this->json([
            'status' => 'success',
            'message' => __(':entity successfully deleted', ['entity' => __('Customer')]),
            'data' => new \stdClass(),
        ]);
    }
    ...
    public function revisions(Request $request, $id)
    {
        ...
        $query = $entry->revisions()->with('customer');
