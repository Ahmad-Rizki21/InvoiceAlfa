...
class DistributionCenterController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->json([
            ...
            'message' => __('Ok'),
            'data' => [
                'distribution_centers' => DistributionCenterResource::collection($entries->items()),
            ],
            'meta' => [
    ...
    public function show(Request $request, $id)
    {
        ...
        return $this->json([
            ...
            'message' => __('Ok'),
            'data' => [
                'distribution_center' => new DistributionCenterResource($entry),
            ],
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $entry = DistributionCenter::create($input);

        return $this->json([
            'status' => 'success',
            'message' => __(':entity successfully created', ['entity' => __('Distribution Center')]),
            'data' => [
                'distribution_center' => new DistributionCenterResource($entry),
            ],
        ]);
    ...
    {
        // $this->authorize('edit.distribution_center');

        $entry = DistributionCenter::find($id);

        if (!$entry) {
            return abort(404, __(':entity not found', ['entity' => __('Distribution Center')]));
        }
        ...
        return $this->json([
            'status' => 'success',
            'message' => __(':entity successfully updated', ['entity' => __('Distribution Center')]),
            'data' => [
                'distribution_center' => new DistributionCenterResource($entry),
            ],
        ]);
    ...
    {
        // $this->authorize('delete.distribution_center');
        ...
        return $this->json([
            'status' => 'success',
            'message' => __(':entity successfully deleted', ['entity' => __('Distribution Center')]),
            'data' => new \stdClass(),
        ]);
    }
    ...
    public function revisions(Request $request, $id)
    {
        ...
        $entry = DistributionCenter::findOrFail($id);

        $query = $entry->revisions()->with('distribution_center');
        ...
        return $this->json([
            ...
            'message' => __('Ok'),
            'data' => [
                'distribution_centers' => $entries->data(),
            ],
            'meta' => [
                'searches' => $searches->original(),
                'total' => $entries->total(),
