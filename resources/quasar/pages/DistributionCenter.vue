<template>
  <q-page class="page-distribution-centers">
    ...
    <div class="page-header">
      <q-toolbar-title>{{ $t('Distribution Centers') }}</q-toolbar-title>
      ...
      >
        <span class="q-ml-xs">{{ $t('New {entity}', { entity: $t('Distribution Center') }) }}</span>
      </q-btn>
    </div>
        ...
        >
          ...
          <template #body-cell-action="{ row }">
            <q-td class="text-right table-cell-action">
              ...
              <q-btn
                v-if="$auth.can('edit.distribution_center')"
                unelevated
                color="default"
                size="sm"
                padding="xs"
...
export default {
  ...
  meta() {
    return {
      title: this.$t('Distribution Centers') + ' - ' + this.$t('Web Console')
    }
  },
  breadcrumbs() {
    return [
      'home',
      { text: this.$t('Distribution Centers') }
    ]
  },
